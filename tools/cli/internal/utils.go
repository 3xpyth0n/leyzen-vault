...
// If the file does not exist, it will be generated by running the build script.
// This function is used before docker compose commands to ensure the file exists.
